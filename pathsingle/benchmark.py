...
if __name__ == '__main__':
    ...
    adata.X = scprep.transform.log(adata.X, pseudo_count=1)  # Add pseudo_count=1 to handle zeros. #For each value x in the expression matrix take log2(x+1). Stabilizes variance and reduces outliers.
